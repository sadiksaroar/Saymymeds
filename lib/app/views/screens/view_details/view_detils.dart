...
//     ever(controller.selectedLanguage, (_) {
//       setState(() {});
//     });
//   }
...
//   late GlobalLanguageController _langController;
//   int _currentIndex = 0;
...
//     _langController = Get.find<GlobalLanguageController>();

//     // Listen to both language and medication data changes
//     ever(_langController.currentLanguage, (_) {
//       setState(() {});
//     });

//     ever(_medicineController.medicationData, (_) {
//       setState(() {});
//     });
//   }
...
//               constraints: const BoxConstraints(maxWidth: 430),
//               child: Obx(() {
//                 if (_medicineController.medicationData.value == null) {
//                   return const Center(
//                     child: Text('No medication data available'),
//                   );
//                 }

//                 final data = _medicineController.medicationData.value!;
//                 final analysis = data.aiAnalysis;

//                 // Get current language display name
//                 final currentLangCode =
//                     _medicineController.selectedLanguage.value;
//                 final currentLangDisplay = _medicineController
//                     .languageMap
//                     .entries
//                     .firstWhere(
//                       (e) => e.value == currentLangCode,
...
//                         child: Column(
//                           children: [
//                             // Top bar with back and language dropdown
//                             Padding(
//                               padding: const EdgeInsets.all(8.0),
//                               child: Row(
//                                 children: [
...
//                                               context.mounted) {
//                                             print(
//                                               '🌐 Dropdown changed to: $newValue',
//                                             );
//                                             await _medicineController
//                                                 .changeLanguage(
//                                                   newValue,
//                                                   context,
//                                                 );
